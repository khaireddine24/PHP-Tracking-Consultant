...
$idC=$_GET['cons'];
$missions = $MissionController->getMissionCon($idC);
?>
...
<body class="container">
            ...
            <?php foreach ($missions as $m) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <!-- for Delete -->
                        <form method="post" action="DeleteMiss.php?cons=<?=$idC?>">
                            <input type="hidden" name="mission_id" value="<?php echo $m['mission_id']; ?>">
                    ...
                    <td>
                          <!-- for checkbox  -->
                          <form method="post" action="ValidateMission.php?cons=<?=$idC?>">
                                <input type="hidden" name="mission_id" value="<?php echo $m['mission_id']; ?>">
                                <input type="checkbox" name="validate" onclick="this.form.submit()"> Is finished
                            </form>
                    </td>
    ...
    <a href="ConsultantDashboard.php?id=<?=$idC;?>" class="btn btn-secondary">Back</a>
